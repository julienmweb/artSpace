                        ...
                        foreach ($_SESSION['produits'] as $value) {
                            ...
                            <div class="pricing__part1__standard">
                                <div class="pricing__part1__header">
                                    <div class="title">
                                        <h2><?php echo $value->getNom(); ?></h2>
                                        <hr class="hr--type4">
                                    </div>
                                    <div class="pricing__part1__content">
                                        <p><span class="bigNumber"><?php echo $value->getPrix(); ?></span>/MO</p>
                                    </div>
                                    <p><a href="index.php?action=ctrlPanier&amp;event=add&amp;id=<?php echo $value->getId(); ?>" class="btn--type3">Ajouter au panier</a></p>
                                    <p><a href="index.php?action=ctrlPricingDetail&amp;id=<?php echo $value->getId(); ?>" class="btn--type3">En savoir plus</a></p>
                                </div>  
                            </div>                       
                            <?php
                        }
                    } else {
                        echo '<p>Aucun produit n existe actuellement dans cette rubrique</p>';
                    }
                    ?>
                </div>                
            </section>
